...
//        mCurrentState = mTargetState = mMediaPlayer != null && mMediaPlayer.isPlaying() ? STATE_PLAYING : STATE_IDLE;
...
//                    }
                    ...
                    if (getWindowToken() != null) {
                        ...
                        new AlertDialog.Builder(getContext())
                                ...
                                .setPositiveButton(R.string.mobile_ok,
...
//            ijkMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "start-on-prepared", 0);
            ...
            ijkMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "max-buffer-size", 10 * 1024 * 1024);
